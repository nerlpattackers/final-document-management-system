<ul>
    ...
    <li class="nav-item">
        <a href="{{ url('/dashboard') }}">
            <span class="icon home-icon">
                ...
                <i class="lni lni-dashboard fs-4"></i>
            </span>
    ...
    <li class="nav-item @if(request()->routeIs('users.index')) active @endif">
        <a href="{{ route('users.index') }}">
            <span class="icon user-icon-container">
                ...
                <i class="lni lni-users user-icon fs-3"></i>
            </span>
            <span class="text">Users</span>
        </a>
    </li>

    {{-- <li class="nav-item @if(request()->routeIs('files.index')) active @endif">
        <a href="{{ route('files.index') }}">
              <span class="icon file-icon-container">
                <svg width="22" height="22" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                </svg>
                <i class="lni lni-files file-icon"></i>
              </span>
        ...
        <a class="collapsed" href="#0" class="" data-bs-toggle="collapse" data-bs-target="#ddmenu_1"
           aria-controls="ddmenu_1" aria-expanded="true" aria-label="Toggle navigation">
            <span class="icon">
                ...
                <i class="lni lni-files file-icon fs-4"></i>
            </span>
            <span class="text">Documents</span>
        </a>
        <ul id="ddmenu_1" class="dropdown-nav collapse" style="">
            <li>
                <a href="{{ url('/incoming_documents') }}">Incoming</a>
            </li>
            <li>
                <a href="{{ url('/outgoing_documents') }}">Outgoing</a>
            </li>
        </ul>
    </li>
</ul>